...
import { pushObjectToArrayAndDeleteOld, readJsonFile, returnPost, deleteFilePathIfExists, readJsonOldChat, getWordCount, readJsonArray } from './chatting/function.js'
...
router.post('/get_reply', makingDecode, checkIfPlanExpire, checkGptWordsLimit, async (req, res) => {
    try {
        ...
        if (replyReply.success) {
            ...
            const wordCount = getWordCount(replyReply.reply);
