...
router.post('/edit-apikey', validateAdmin, async (req, res) => {
    try {
        await query(`UPDATE apikeys SET openai_keys = ?, aws_polly_id = ?, aws_polly_keys = ?, bard_ai_api = ?`, [req.body.openai_keys, req.body.aws_polly_id, req.body.aws_polly_keys, req.body.bard_ai_api])
