...
import { Bard } from '../chatting/bard-by-hamid/dist/index.js'
...
function getReplyFromBard(question, api) {
    return new Promise(async (resolve) => {
        try {
            const cookies = `__Secure-1PSID=${api}`
...
export { createFilePath, deleteFilePathIfExists, readJsonOldChat, getReplyFromBard, returnPost, readJsonArray, pushObjectToArrayAndDeleteOld, readJsonFile, getWordCount }